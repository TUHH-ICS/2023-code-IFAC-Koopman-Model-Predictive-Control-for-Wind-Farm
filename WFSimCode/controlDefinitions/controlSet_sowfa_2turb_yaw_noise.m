function turbInputSet = controlSet_sowfa_2turb_yaw_noise(Wp)
...
shN = randn(lNoise,1);
sHMat = repmat(shN',nNoise,1)*0.4 +1.2;
noiseVec1 = sHMat(:);

shN = randn(lNoise,1);
sHMat = repmat(shN',nNoise,1)*0.4 +1.3;
noiseVec2 = sHMat(:);
