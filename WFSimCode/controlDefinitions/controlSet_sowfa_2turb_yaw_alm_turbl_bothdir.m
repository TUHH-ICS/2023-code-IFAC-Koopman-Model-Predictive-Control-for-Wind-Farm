function turbInputSet = controlSet_sowfa_2turb_yaw_alm_turbl_bothdir(Wp)
...
turbInputSet.phi = [0*turbInputSet.phi(1,1:31)+10,turbInputSet.phi(1,32:end)+10;...
    0*turbInputSet.phi(2,1:31),turbInputSet.phi(2,32:end)];
