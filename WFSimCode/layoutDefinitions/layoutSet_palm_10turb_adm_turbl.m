function [Wp] = layoutSet_palm_10turb_adm_turbl()

Wp = struct('description','10 NREL 5MW turbines case, turbulent inflow, based on a PALM ADM simulation');
...
Wp.turbine = struct(...
    'Crx',[250,880,1510,2140,2770,250,880,1510,2140,2770],... % X-coordinates of turbines (m)
    'Cry',[200,578,200,578,200,578,200,578,200,578],... % Y-coordinates of turbines (m)
...
Wp.mesh = struct(...
    ...
    'Ly',778.0,... % Domain length in y-direction
    'Nx',100,... % Number of cells in x-direction
    'Ny',50 ... % Number of cells in y-direction
    );

% Tuning notes '10turb_adm_turbl' (Jan 6th, 2019):
% Manually tuned
