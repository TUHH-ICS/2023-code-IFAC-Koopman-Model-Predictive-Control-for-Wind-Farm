...
Wp.turbine = struct(...
    ...
    'Cry',[400.0000  400.0960],... % Y-coordinates of turbines (m)
...
Wp.mesh = struct(...
    ...
    'Ly',800.1,... % Domain length in y-direction
    'Nx',50*4,... % Number of cells in x-direction
    'Ny',25*3 ... % Number of cells in y-direction
    );
