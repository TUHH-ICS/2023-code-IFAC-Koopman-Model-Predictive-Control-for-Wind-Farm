function [JR,JQ] = plotWFSimTimeseries(Wp,sol_array,controller,Power,CT_prime,Phi,V,JR,time,measured,figName,dirFig,mpc)
...
subplot(5,1,4)
usePhi = mean(diff(Phi(1,6:end))) > 0 || any(Phi(1,6:end)) >0;
if usePhi
    for idx = 1:N
