...
% filenameId = 'Vinf6dot3_sowfa_2turb_alm_turbl_AllComb'; %'Vinf8dot5_sowfa_2turb_alm_turbl_AllComb.mat';
% filenameVal = 'Vinf8dot5_sowfa_2turb_alm_turbl.mat';
% filenameId = 'Vinf8dot5_sowfa_2turb_alm_turbl_AllComb.mat';
% filenameVal = 'Vinf8dot5_sowfa_2turb_alm_turbl.mat';

filenameId =  'Vinf11dot0_sowfa_2turb_yaw_alm_turbl_AllComb1.mat'; %'Vinf7dot9_Stairs1sowfa_2turb_yaw_alm_combined2.mat';
filenameVal = 'Vinf7dot9_Stairs1sowfa_2turb_yaw_alm_combined2.mat';
...
% User input
noStates = [6,12,12,24]; %number of Koopman states [12,12,14,18,24]
...
xk = kron(ones(Library_Update_Prediction_Horizon,1),[x0;u0]); % ToDo ADi Second vector [x0;u] 
xk_ = kron(ones(Library_Update_Prediction_Horizon,1),[x0;u0]);
