% Code based on Model Predictive Control For Wake Steering: a Koopman Dynamic Mode
% Decomposition Approach, Master Thesis Dissertation
...
% (3) Validates the models with a set of validation data
...
% filenameId = 'Vinf7dot0_sowfa_2turb_alm_turbl_AllComb.mat'; 
...
% User input
noStates = 12; % [6,12,12,14,16,18,24];
useVal = 1; % use extra data for validation
percentTrain = .6;
t0 = 1; % first data point of id
...
%% (1) ASSESS DATA
% easy solution to append u flow field data matrix with other flow
% field data
...
FITje = vaf(statesvalidVinf(1:ny,1:5100),ysim(:,1:5100));
