function [Inputs, Outputs, Deterministic] = preprocessdmdval(beg,dataSOFWA,pitchmode,rho,scalingfactors,meanY1,meanY2,meanX1,meanX2)

%% deal with mean input
